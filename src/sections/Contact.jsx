...
const Contact = () => {
 ...
 const handleSubmit = async (e) => {
    ...
    try {
        ...
        await emailjs.send("service_z4hfeim", "template_pa456u3", {
        from_name : formData.name,
        to_name : "Ansh",
        from_email : formData.email,
        to_email : "4gansh11@gmail.com",
  ...
  return (
    <section id="contact" className="relative flex items-center c-space section-spacing">
        ...
        justify-center max-w-md p-5 mx-auto border
         border-white/10 rounded-2xl bg-primary">
            ...
            <form className="w-full">
                ...
                <div className="mb-5">
                    ...
                    onChange={handleChange}
                    placeholder="example007@gmail.com" required
                    autoComplete="email"
                     />
                </div>
                <div className="mb-5">
